...
class Sign_to_text:
	def __init__(self):
		...
		self.mode = "Character"
		self.modelabel = Label(self.root ,bg = "antique white" ,text = self.mode, fg = "spring green" , font=("Courier",30))
		self.modelabel.place(x = 700 , y = 650)
		...
		#sentence
		self.label1 = Label(self.root , text = "Sentence:" , bg = "antique white" , fg = "red", font=("Courier",20))
		self.label1.place(x = 50 , y = 700)

		self.label2 = Label(self.root , bg = "antique white" , fg = "yellow")
		self.label2.place(x = 250 ,y = 700)

		#Predicted letter
		self.label3 = Label(self.root , text = "Predicted letter:" , bg = "antique white" , fg = "red" , font=("Courier",20))
		self.label3.place(x = 50 , y = 580)

		self.label4 = Label(self.root ,bg = "antique white" , fg = "cyan" , font=("Courier",20))
		self.label4.place(x = 350 , y = 580)

		#word formation
		self.label5 = Label(self.root , text = "Current Word:" , bg = "antique white" , fg = "red", font=("Courier",20))
		self.label5.place(x = 50 , y = 640)

		self.label6 =  Label(self.root ,bg = "antique white" , fg = "cyan" , font=("Courier",20))
		self.label6.place(x = 350 , y = 640)
		#suggestion header
		self.label7 = Label(self.root ,bg = "antique white" ,text ="Suggestions", fg = "spring green" , font=("Courier",30))
		...
		self.bt0 = Button(self.root ,text = "Emergency" ,font = ("Courier",15,"bold"),command = self.Emergency , bg = "DeepPink2", fg = "deepskyblue2")
		self.bt0.place(x=600, y=500)

		self.bt01 = Button(self.root ,text = "Shortcuts" ,font = ("Courier",15,"bold"),command = self.Shortcut , bg = "DeepPink2", fg = "deepskyblue2")
		self.bt01.place(x=750, y=500)

		
		#sign to speech buuton
		self.bt_speak = Button(self.root , text = "Speak" , font =("Courier",15,"bold"),command = self.action , bg = "DeepPink2", fg = "deepskyblue2")
		self.bt_speak.place(x=800, y=500)

		#reset buttons
		self.bt_reset = Button(self.root , text = "Reset" ,font = ("Courier",15,"bold"),command = self.action,bg = "DeepPink2", fg = "deepskyblue2")
		self.bt_reset.place(x=1000, y=500)

		#Suggestion buttons
		self.bt1 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt1.place(x = 1125,y=60)

		self.bt2 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt2.place(x = 1265,y=110)

		self.bt3 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt3.place(x = 1405,y=60)

		self.bt4 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt4.place(x = 1125,y=160)

		self.bt5 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt5.place(x = 1265,y=210)

		self.bt6 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt6.place(x = 1405,y=160)

		self.bt7 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt7.place(x = 1125,y=270)

		self.bt8 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt8.place(x = 1265,y=330)

		self.bt9 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt9.place(x = 1405,y=270)

		self.bt10 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt10.place(x = 1125,y=390)

		self.bt11 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
		self.bt11.place(x = 1265,y=450)

		self.bt12 = Button(self.root , command = self.action ,bg = "DeepPink2", fg = "gray1" , height = 0,width = 0,font = ("Courier",20))
